"""task_x_28121 URL Configuration
...
admin.site.site_header = "Task X"
admin.site.site_title = "Task X Admin Portal"
admin.site.index_title = "Task X Admin"

# swagger
api_info = openapi.Info(
    title="Task X API",
    default_version="v1",
    description="API documentation for Task X App",
)
